    ...
    return (
      <div className="flex h-screen items-center justify-center bg-gray-50 dark:bg-zinc-950 transition-colors">
        <button 
          ...
          className="px-6 py-2 bg-yellow-400 text-black font-bold rounded shadow-sm hover:bg-gray-500 transition"
        >
          Return to Dashboard
        </button>
      </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 text-gray-900 dark:text-zinc-50 font-sans p-6 md:p-12 transition-colors">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-12 animate-in slide-in-from-bottom-4 duration-500">
           <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-gray-200 dark:bg-zinc-900 border border-gray-300 dark:border-zinc-800 rounded-full text-[10px] font-bold uppercase tracking-widest text-gray-300 dark:text-zinc-400 mb-4 transition-colors">
                 Session Complete
                 <span className="w-1.5 h-1.5 rounded-full bg-yellow-400"></span>
              </div>
              <h1 className="text-3xl md:text-5xl font-bold tracking-tight mb-2">Performance Synthesis</h1>
              <p className="text-gray-300 dark:text-zinc-400 font-mono text-sm max-w-lg">
                 Target: <span className="text-yellow-400 dark:text-yellow-400">{interview.role}</span> // Bracket: <span className="text-yellow-400 dark:text-yellow-400">{interview.experience}</span>
              </p>
           </div>
           ...
           <div className="mt-8 md:mt-0 flex items-center gap-6 p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 shadow-sm dark:shadow-none transition-colors">
              <div className="flex flex-col text-right">
                 <span className="text-[10px] font-bold text-gray-300 dark:text-zinc-500 uppercase tracking-widest mb-1">Global Score</span>
                 <span className="text-3xl font-bold font-mono">
                   {actualScore}<span className="text-lg text-gray-300 dark:text-zinc-600">/{totalPossible}</span>
                 </span>
              </div>
              ...
              >
                ...
                <div className="bg-gray-50 dark:bg-zinc-900/80 p-5 px-6 flex items-start justify-between border-b border-gray-200 dark:border-zinc-800 transition-colors">
                   <div className="flex-1 pr-6">
                      <div className="flex items-center gap-3 mb-2">
                         <span className="px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-widest bg-gray-200 dark:bg-zinc-800 text-gray-300 dark:text-zinc-400 transition-colors">
                           Node {index + 1}
                         </span>
                      </div>
                   ...
                   <div className={`shrink-0 w-14 h-14 rounded-xl flex flex-col items-center justify-center border bg-white dark:bg-zinc-950 transition-colors ${
                      color === 'emerald' ? 'border-yellow-400 dark:border-yellow-400/30' : 
                      color === 'rose' ? 'border-yellow-400 dark:border-yellow-400/30' : 
                      'border-yellow-400 dark:border-yellow-400/30'
                   }`}>
                      <span className={`text-xl font-bold ${
                         color === 'emerald' ? 'text-yellow-400 dark:text-yellow-400' : 
                         color === 'rose' ? 'text-yellow-400 dark:text-yellow-400' : 
                ...
                <div className="p-6 md:flex divide-y md:divide-y-0 md:divide-x divide-gray-100 dark:divide-zinc-800 transition-colors">
                   ...
                   <div className="md:w-1/2 md:pr-6 pb-6 md:pb-0">
                      <h5 className="text-[10px] uppercase tracking-widest text-gray-300 dark:text-zinc-500 font-bold mb-3 flex items-center gap-2">
                         <span className="w-1.5 h-1.5 rounded-full bg-yellow-400"></span>
                           ...
                           <ul className="space-y-2">
                              {res.suggestions.map((sug, i) => (
                                 <li key={i} className="text-xs text-gray-600 dark:text-zinc-400 flex items-start gap-2">
                                    <svg className="w-4 h-4 text-yellow-400 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
        ...
        <div className="mt-12 flex justify-center pb-12">
           ...
           >
             <svg className="w-5 h-5 text-gray-300 dark:text-zinc-500 group-hover:-translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" /></svg>
